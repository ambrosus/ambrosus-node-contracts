...
describe('Block rewards contract', () => {
  ...
  describe('setBaseReward', () => {
    ...
    it('emits an event', async () => {
      ...
      expect(baseRewardChangeEvents[0].returnValues.oldBaseReward).to.equal(exampleBaseReward);
      expect(baseRewardChangeEvents[0].returnValues.newBaseReward).to.equal(exampleDifferentBaseReward);
    });
