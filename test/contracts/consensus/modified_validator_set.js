...
import ModifiedValidatorSetJson from '../../../src/contracts/ModifiedValidatorSet.json';
...
describe('Validator set contract', () => {
  ...
  const deploy = async (web3, sender, owner, initialValidators, superUser) => deployContract(web3, ModifiedValidatorSetJson, [owner, initialValidators, superUser], {from: sender});
