...
contract MockContext is Context {
    ...
    constructor(address[] _trustedAddresses, Catalogue _catalogue, StorageCatalogue _storageCatalogue)
    Context(_trustedAddresses, _catalogue, _storageCatalogue) public {}
