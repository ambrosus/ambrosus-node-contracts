...
contract RolesEventEmitter is Base {
    ...
    event MasternodeOnboarded(address nodeAddress, uint placedDeposit, Consts.NodeType role);
    event MasternodeRetired(address nodeAddress, uint releasedDeposit, Consts.NodeType role);

    function masternodeOnboarded(address nodeAddress, uint placedDeposit, Consts.NodeType role) public onlyContextInternalCalls {
        emit MasternodeOnboarded(nodeAddress, placedDeposit, role);
    }
